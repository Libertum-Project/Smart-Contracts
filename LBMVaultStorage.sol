...
contract LBMVaultAdminStorage {
    ...
    */
    ...
    /**
    * @notice Active brains of LBM Vault
    */
    address public implementation;

    /**
    * @notice Pending brains of LBM Vault
    */
    address public pendingLBMVaultImplementation;
}

contract LBMVaultStorageV1 is LBMVaultAdminStorage {
    /// @notice Guard variable for re-entrancy checks
    bool internal _notEntered;

    /// @notice The reward token store
    address public lbmStore;

    /// @notice The lbm token address
    address public lbmAddress;
...
contract LBMVaultStorage is LBMVaultStorageV1 {
